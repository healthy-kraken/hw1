...
/*
SPRINT 3: Reading Table -- Reading List of Movies with their studio
*/
...
/*
SPRINT 4: Reading Table -- Reading Casting List
*/ 
...
/*
SPRINT 5: Reading Table -- Actors represented
*/

SELECT actors.first_name, actors.last_name, agents.first_name, agents.last_name FROM actors
INNER JOIN networks ON networks.actor_id = actors.id
INNER JOIN agents ON agents.id = networks.agent_id;
/**/
